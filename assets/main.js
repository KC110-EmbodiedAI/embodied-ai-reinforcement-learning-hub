(function () {
  const translations = {
    zh: {
      ...
      demoFourTitle: "实机部署验证视频",
      demoFourBody: "展示实机部署、运行过程和验证表现。",
      ...
      downloadPlatformDocs: "平台文档与评价说明",
      downloadPlatformDocsUse: "用于了解平台使用、阶段说明、操作规范和评价标准",
      downloadLab: "实验手册",
    ...
    en: {
      ...
      demoFourTitle: "Real-machine deployment validation video",
      demoFourBody: "Show real-machine deployment, runtime behavior, and validation performance.",
      workflowLabel: "Class Workflow",
      ...
      downloadPlatformDocs: "Platform docs and evaluation guide",
      downloadPlatformDocsUse: "For platform usage, stage guidance, operating notes, and evaluation standards",
