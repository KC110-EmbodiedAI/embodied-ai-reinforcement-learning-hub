(function () {
  const translations = {
    zh: {
      ...
      consoleResourceTitle: "讲义 / 代码 / 演示",
      consoleResourceOne: "实验手册待上传",
      consoleResourceTwo: "演示视频占位",
      consoleResourceThree: "评价量规预留",
      ...
      resourcesIntro:
        "后续资料会按学生使用顺序补充。当前版本先建立分类、状态和下载入口，避免资料分散在聊天、课件和临时链接中。",
      ...
      studioTitle: "教学演示区",
      studioIntro:
        "演示区用于放置课堂讲解、训练过程、机器人仿真、部署验证和常见失败案例。当前只保留占位框，真实素材将在脱敏后补充。",
      ...
      downloadsTitle: "下载中心",
      downloadsIntro:
        "这里将成为学生获取课程文件的固定入口。当前仓库只包含目录说明，真实文件请在确认公开范围后加入。",
      downloadColOne: "资源",
      downloadColTwo: "用途",
      downloadColThree: "状态",
      downloadColFour: "入口",
    ...
    en: {
      ...
      consoleResourceTitle: "Notes / Code / Demos",
      consoleResourceOne: "Lab manual pending",
      consoleResourceTwo: "Demo video slots",
      consoleResourceThree: "Rubric reserved",
      ...
      resourcesIntro:
        "Future materials will be added in the order students use them. This version establishes categories, status, and download entry points.",
      resourceGuideType: "Guide",
      ...
      studioIntro:
        "This area will host lectures, training traces, robot simulation, deployment validation, and common failure cases. Current slots are placeholders only.",
      demoFrameOne: "Game Simulation",
      demoFrameTwo: "Quadruped Control",
      demoFrameThree: "Training Trace",
      demoFrameFour: "Deployment Check",
      ...
      downloadsIntro:
        "This will be the stable entry point for course files. The current repository contains directory notes only; real files should be added after release review.",
